...
#define FRAM_VOLUME 0x0121 //start address for volume settings
#define FRAM_LED_BRIGHTNESS 0x0122 // Setting for LED brightness
#define FRAM_DISPLAY_BRIGHTNESS 0x0123 //Setting for display brightness
